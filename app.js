angular.module("airbnb", [])
  ...
  .controller('CardsCtrl', ['$scope', function($scope) {
    ...
    {size: "col-lg-4 col-md-6 hide-sm rm-padding-sm col-switch col-md-push-6 col-lg-push-0", image: "background-image:url('https://a1.muscache.com/ic/discover/308?interpolation=lanczos-none&output-format=jpg&output-quality=70&v=33b4f2&downsize=326px:326px');", title: "Seattle"},
